...
| **Servo SG90** <div  align="center"> <img width="522" height="522" alt="51Fh0G9sO+L _SX522" src="https://github.com/user-attachments/assets/4f3b3663-a6a0-442f-b0ed-0c96d0162d08" /> </div> | Se ha seleccionado el servomotor SG90 debido a su diseño ultraligero (aproximadamente 9 gramos) y su factor de forma miniatura, lo que permite integrarlo fácilmente en espacios reducidos sin añadir peso innecesario al chasis o a los mecanismos móviles. Su capacidad para ofrecer un control preciso de posición angular mediante modulación por ancho de pulso (PWM) lo convierte en el actuador ideal para tareas de bajo torque que requieren exactitud, tales como la orientación de sensores, mecanismos de dirección ligeros o compuertas de liberación, manteniendo un consumo de corriente moderado compatible con la alimentación lógica del sistema. |
